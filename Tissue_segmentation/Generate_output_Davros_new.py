import os
from step2_tissue_seg.subpackages import NetworkOptions
from step2_tissue_seg import mimo_net
import tensorflow as tf
tf.reset_default_graph()

# os.environ['CUDA_VISIBLE_DEVICES'] = '-1'

# these will be arguments to the function belo
# data_dir = sys.argv[1]
# sub_dir_name = sys.argv[2]
#
# d = {'exp_dir': 'ExpDir'}
# with open(os.path.join(data_dir, 'parameters-tissuesegment_test.txt')) as param:
#     for line in param:
#         a = line.split(' ')
#         d[a[0]] = a[1].strip('\n')

def run_tissue_segmentation(data_dir,
                            results_dir,
                            sub_dir_name,
                            file_name_pattern,
                            exp_dir='step2_tissue_seg/ExpDir-HE',    # this could be moved to main.py???
    ...
    opts = NetworkOptions.NetworkOptions(exp_dir=exp_dir,
                                         ...
                                         pre_process=True, #FLASE to disable matlab
