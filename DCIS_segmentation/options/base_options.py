...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='TBCRC_19092021_VC_300', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default=r'Z:\Rob\ALMA-test_result\20092021\TBCRC_19092021_VC_300', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default=r'T:\COPAINGE\DCIS_Duke_Faranak\TBCRC\PIX2PIX\V1-OLr-pix2pixHD-master\datasets\HEData\SET1_cws\MDA-013_A26_2_1565493.svs')
        self.parser.add_argument('--resize_or_crop', type=str, default='scale_width', help='scaling and cropping of images at load time [resize_and_crop|crop|scale_width|scale_width_and_crop]')
        self.parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')        
        self.parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for data argumentation') 
        self.parser.add_argument('--no_rotate', action='store_true', help='if specified, do not rotate the images for data argumentation') 
        self.parser.add_argument('--nThreads', default=8, type=int, help='# threads for loading data')                
        self.parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        self.parser.add_argument('--no_blur', action='store_true', help='if specified, do not blur the images for data argumentation')
