...
class NetworkOptions:
    ...
    def __init__(self,
        ...
        self.maxclique_distance = maxclique_distance
        self.maxclique_threshold = maxclique_threshold
        ...
        if preprocessed_dir is None:
            self.preprocessed_dir = os.path.join(self.results_dir, results_subdir)
        else:
